...
function locationData(value){
  ...
  return LOCATIONS.find(item=>item.name===value)||{name:String(value||'Локация'),background:''};
}
...
const sounds = Object.fromEntries(Object.entries(SOUND_PATHS).map(([key,path])=>{
